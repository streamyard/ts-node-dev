...
exports.runDev = function (script, scriptArgs, nodeArgs, opts) {
    ...
    function initWatcher(_a) {
        var isCliPathWatcher = (_a === void 0 ? {} : _a).isCliPathWatcher;
        ...
        watcher.on('change', function (path) {
            restart(path, { isCliPathWatcher: isCliPathWatcher });
        });
        if (!isCliPathWatcher) {
    ...
    // for these.
    var cliPathWatcher = initWatcher({ isCliPathWatcher: true });
    var starting = false;
    ...
    function start() {
        ...
        ipc.on(child, 'required', function (m) {
            ...
            if (!isIgnored && (cfg.deps === -1 || getLevel(required) <= cfg.deps)) {
                ...
                watcher.add(opts.poll ? required : path_1.default.dirname(required));
            }
        });
    ...
    function restart(file, _a) {
        var _b = _a === void 0 ? {} : _a, isCliPathWatcher = _b.isCliPathWatcher, isDeletion = _b.isDeletion, isManualRestart = _b.isManualRestart;
